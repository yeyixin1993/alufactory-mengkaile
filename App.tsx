                ...
                <div key={item.id} className="bg-white p-8 rounded-[2.5rem] shadow-2xl border border-slate-100 flex flex-col group hover:border-blue-200 transition-all">
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      ...
                      <div className="text-xs font-black text-slate-400 mt-1 uppercase flex items-center gap-2">
                        {t.quantity}: 
                        <span className="text-slate-900 bg-slate-100 px-3 py-1 rounded-lg text-sm">{item.quantity}</span>
                      </div>
                    </div>
