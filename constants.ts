...
export const SHIPPING_RATES_AN: Record<string, { first: number, next: number }> = {
  ...
  '内蒙': { first: 80, next: 3.7 },
  '黑龙江': { first: 80, next: 3.2 },
  '吉林': { first: 80, next: 3.2 },
  '甘肃': { first: 80, next: 3.7 },
  '宁夏': { first: 80, next: 3.7 },
  '青海': { first: 80, next: 3.7 },
  '重庆': { first: 80, next: 3.3 },
  '广西': { first: 51, next: 3.1 },
  '贵州': { first: 55, next: 3.3 },
  '海南': { first: 80, next: 4 },
  '辽宁': { first: 80, next: 3.2 },
  '四川': { first: 80, next: 3.3 },
  '云南': { first: 62, next: 3.7 },
  '福建': { first: 46, next: 2.6 },
  '广东': { first: 55, next: 2.5 },
  '山东': { first: 50, next: 2.4 },
  '山西': { first: 53, next: 3.1 },
  '陕西': { first: 53, next: 3.1 },
  '北京': { first: 54, next: 2.5 },
  '河北': { first: 52, next: 2.5 },
  '河南': { first: 52, next: 2.7 },
  '湖北': { first: 52, next: 2.7 },
  '湖南': { first: 52, next: 2.7 },
  '江西': { first: 50, next: 2.4 },
  '天津': { first: 52, next: 2.5 },
