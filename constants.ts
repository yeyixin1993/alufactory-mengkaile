...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  en: {
    ...
    phoneFormatHint: '11-digit mobile number; optional 4-digit virtual number after “-”.',
    phoneRequired: 'Phone number is required',
    phoneInvalid: 'Use 11 digits, optionally followed by “-” and a 4-digit virtual number.',
    ...
    qq_profileShippingNote: 'Profile and marine board shipping is combined by weight and automatically uses the cheapest courier',
  ...
  cn: {
    ...
    qq_profileShippingNote: '型材和海洋板按合并重量与省份计算运费，并自动选择最便宜快递',
  ...
  jp: {
    ...
    cartRestoreFailed: '保存済みカートの復元に失敗しました。再試行してください。',
    total: '合計',
    price: '価格',
    quantity: '数量',
    ...
    phoneInvalid: '11桁の番号、または「11桁-4桁の仮想番号」で入力してください。',
    provinceCity: '都道府県',
    addressDetail: '住所詳細',
    shippingFee: '送料',
    overlengthFee: '延長料金',
    ...
    qq_profileShippingNote: 'プロファイルとマリンボードは合計重量と配送先で送料を計算し、最安配送を自動選択',
...
export const PROFILE_COLORS: ColorDef[] = [
  ...
  { id: 'willow_green', name: { en: 'Willow Green', cn: '柳绿色', jp: '柳緑' }, maxLength: 3000 },
  { id: 'qingli_coffee', name: { en: 'Qingli Coffee', cn: '青骊咖色', jp: '青驪コーヒー' }, maxLength: 3000 },
