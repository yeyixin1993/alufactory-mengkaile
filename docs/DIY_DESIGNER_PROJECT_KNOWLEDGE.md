...
- Initial verified mappings include MayCAD `2020-22SP` → `2020-N2`, `2020-21SP` → `2020-N1`, ordinary `2020` → `2020`, and MayCAD `2040` → `2040-N1-40` with a review warning where the covered face is uncertain.
